...
pokemon_csv = pd.read_csv("C:\ENSG\Projet_Info\RATHANA-BOUCHART-KACZOR\data\pokemon_first_gen.csv", skiprows=1)#
pokemon_position=pd.read_csv("C:\ENSG\Projet_Info\RATHANA-BOUCHART-KACZOR\data\pokemon_coordinates.csv",skiprows=1)
...
#Création d'un dictionnaire avec comme clés le nom des pokemons auxquels otn associe leur numéro dans le Pokedex, pour pouvoir optimiser les recherches
